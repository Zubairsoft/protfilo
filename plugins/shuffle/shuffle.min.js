!(function (t, e) {
  ...
  (g.Css = {
    ...
    (g.Scale = { VISIBLE: 1, HIDDEN: 0.001 });
  var _ = null,
    E = function () {
      if (null !== _) return _;
  ...
  function C(t) {
    return (
      !!T[t] &&
      (T[t].element.removeEventListener(k, T[t].listener), (T[t] = null), !0)
    );
  }
  function L(t, e) {
    var i = k + (w += 1),
    ...
    return t.addEventListener(k, n), (T[i] = { element: t, listener: n }), i;
  }
  function D(t) {
            ...
            },
            {
              ...
              value: function (t) {
                return "function" == typeof this.options.gutterWidth
                  ...
                  : this.options.sizer
                  ? I(this.options.sizer, "marginLeft")
              ...
              value: function (t) {
                ...
                t.forEach(function (t, s) {
                  ...
                  if (m.equals(t.point, i[s]) && !t.isHidden)
                    return t.applyCss(g.Css.VISIBLE.before), void o();
                  (t.point = i[s]),
            ...
            },
            {
              ...
              value: function () {
                ...
                e.forEach(function (e) {
                  ...
                  if (e.isHidden)
                    return e.applyCss(g.Css.HIDDEN.before), void n();
          ...
          [
            {
              ...
              value: function (t) {
                var e =
                  ...
                  s = I(t, "height", i);
                e &&
                  ((n += I(t, "marginLeft", i) + I(t, "marginRight", i)),
  ...
  return (
    ...
    (N.EventType = { LAYOUT: "shuffle:layout", REMOVED: "shuffle:removed" }),
    (N.Classes = v),
    (N.FilterMode = { ANY: "any", ALL: "all" }),
    (N.options = {
      group: N.ALL_ITEMS,
      speed: 250,
